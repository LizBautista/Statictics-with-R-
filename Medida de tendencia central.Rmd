...
## **Media aritmética**  <font size=4 color="red"> **[Datos no agrupados]**</font>
...
```
## **Media aritmética**  <font size=4 color="red"> **[Datos agrupados discretos]**</font>

## **Media aritmética**  <font size=4 color="red"> **[Datos agrupados continuos]**</font>

## **Media aritmética acotada**

Una media acotada elimina la influencia de valores extremos (valores muy grandes o muy pequeños); ya que, se excluye cierto porcentaje de datos extremos de la muestra ordenada. Una vez que se han
...
library(modeest) # this library help us to get the mode directly

# Show data
knitr::kable(trees, digits = 1, align = "ccc", caption = "Trees data" )

# Option 1 
mlv(trees$Volume, method = "mfv") # we use the library modeest
```
```{r }
#Option 2 
